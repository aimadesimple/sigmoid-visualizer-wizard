...
const MathWorkings = ({ inputValue, result }: MathWorkingsProps) => {
  ...
  return (
    <div className="space-y-4">
      {/* Formula */}
      <div className="bg-palette-light-blue/10 p-4 rounded-lg border-2 border-palette-light-blue/30">
        <h3 className="font-bold text-black mb-2">Sigmoid Function Formula:</h3>
      ...
      <div className="space-y-3">
        <h3 className="font-bold text-black">Step-by-step calculation:</h3>
        ...
        <div className="bg-palette-green/10 p-3 rounded border-2 border-palette-green/30">
      ...
      {/* Properties */}
      <div className="bg-palette-teal/10 p-4 rounded-lg border-2 border-palette-teal/30">
        <h3 className="font-bold text-black mb-2">Properties:</h3>
